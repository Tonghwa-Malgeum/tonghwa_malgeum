...
INSERT INTO posts (id, title, welfare_center_id, url, category, created_date, last_modified_date) 
VALUES (3, '첫 번째 채용공고', 1, 'https://example.com/job1', 'JOB', NOW(), NOW());
INSERT INTO posts (id, title, welfare_center_id, url, category, created_date, last_modified_date) 
VALUES (4, '두 번째 채용공고', 2, 'https://example.com/job2', 'JOB', NOW(), NOW());

-- PostJob Data
INSERT INTO post_jobs (id, recruitment_start_date, recruitment_end_date, post_id, created_date, last_modified_date) 
VALUES (1, NOW(), DATE_ADD(NOW(), INTERVAL 30 DAY), 3, NOW(), NOW());
INSERT INTO post_jobs (id, recruitment_start_date, recruitment_end_date, post_id, created_date, last_modified_date) 
VALUES (2, NOW(), DATE_ADD(NOW(), INTERVAL 15 DAY), 4, NOW(), NOW());