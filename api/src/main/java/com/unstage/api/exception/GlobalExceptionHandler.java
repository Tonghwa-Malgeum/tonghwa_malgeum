package com.unstage.api.exception;
...
public class GlobalExceptionHandler {
    ...
    /**
     * UnstageException의 하위 예외들을 처리합니다.
     *
     * @param ex 발생한 예외
     * @return 에러 응답을 담은 ResponseEntity
     */
    @ExceptionHandler(UnstageException.class)
    public ResponseEntity<ErrorResponse> handleUnstageException(UnstageException ex) {
        ErrorResponse errorResponse = new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                ex.getMessage(),
                LocalDateTime.now()
